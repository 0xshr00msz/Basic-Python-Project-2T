...
if menu == 2:
    ...
    fileHandler = Register(timeOut())
    fileHandler.appendTimeOut(date.strftime("%I") +  ":" + date.strftime("%M") + date.strftime("%p"))


# fileHandler.append_to_file(newDate.strftime("%b") + " " + newDate.strftime("%d") + " " + newDate.strftime("%Y") + ": ")
# fileHandler.write_to_file(date.strftime("%b") + " " + date.strftime("%d") + " " + date.strftime("%Y") + ": ")
#     print(fileHandler.read_file())
